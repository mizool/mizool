...
/**
 * Utility used by all annotations to lookup the {@link javax.cache.annotation.CacheResolver} and {@link javax.cache.annotation.CacheKeyGenerator} for a given method.
 *
...
public abstract class AbstractCacheLookupUtil<I> implements CacheContextSource<I> {
   ...
   * uses {@link java.lang.reflect.Method#getAnnotation(Class)}
   * </p>
   ...
   * @throws java.lang.annotation.AnnotationFormatError if an invalid combination of annotations exist on the method
   */
  @Override
  ...
  /**
   * Create a StaticCacheInvocationContext implementation specific to the {@link javax.cache.annotation.CacheResult} annotated method
   *
  ...
  /**
   * Create a StaticCacheInvocationContext implementation specific to the {@link javax.cache.annotation.CachePut} annotated method
   *
  ...
  /**
   * Create a StaticCacheInvocationContext implementation specific to the {@link javax.cache.annotation.CacheRemoveAll} annotated method
   *
  ...
  /**
   * Used to generated parameter details data out of {@link AbstractCacheLookupUtil#getParameterDetails(java.lang.reflect.Method, boolean)}
   */
   ...
   * @param cacheValueAllowed If the {@link javax.cache.annotation.CacheValue} annotation is legal for this method
  ...
  /**
   * Used to load {@link javax.cache.annotation.CacheKeyGenerator} and {@link javax.cache.annotation.CacheResolverFactory} instances by type
   */
   ...
   * @throws java.lang.annotation.AnnotationFormatError If target is null and no cache name is specified in the method or class level annotations
   */
  ...
  /**
   * Defines a cache key based on the combination of a {@link java.lang.reflect.Method} and {@link Class}.
   */
