...
class JdbcStringFromCharValueLoadStrategy extends AbstractJdbcValueLoadStrategy
{
    public JdbcStringFromCharValueLoadStrategy()
    {
        super(Types.CHAR, DataType.STRING);
    }
