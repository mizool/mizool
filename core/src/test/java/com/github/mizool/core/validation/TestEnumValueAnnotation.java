...
public class TestEnumValueAnnotation
{
    ...
    {
        BeanValidation.assertUnacceptableValue(new TestData(value), EnumValue.class);
    }
    ...
    {
        BeanValidation.assertUnacceptableValue(new TestListData(values), EnumValue.class);
    }
