...
public class TestConstraintValidators
{
    ...
    {
        boolean result = ConstraintValidators.isValid(validationObject, type.isMandatory(), scalarCheck, scalarClass);
        assertThat(result).isEqualTo(validationResult.result);
    }
